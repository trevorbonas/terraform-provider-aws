...
description: |-
  Terraform resource for managing an AWS Timestream for InfluxDB Db Instance.
---
<!---
...
* `arn` - ARN of the Db Instance. Do not begin the description with "An", "The", "Defines", "Indicates", or "Specifies," as these are verbose. In other words, "Indicates the amount of storage," can be rewritten as "Amount of storage," without losing any information.
...
```console
% terraform import aws_timestreaminfluxdb_db_instance.example db_instance-id-12345678
```
